    ...
    return (
        <footer className="bg-muted py-16">
            <div className="mx-auto max-w-5xl px-6">
                ...
                <span className="text-muted-foreground block text-center text-sm"> © {new Date().getFullYear()} Terracotta, All rights reserved</span>
                <span className="text-muted-foreground block text-center text-sm"> <br></br>Crafted with ❤️ in Hong Kong</span>
            </div>
        </footer>
    )
}
